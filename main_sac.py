...
while True:
    ...
    # if False:
        ...
        env_model, ev_score, r2_score, mean, std = get_environment_model(
                ...
                safety.Box(env.observation_space.low, env.observation_space.high),
        ...
        safety = safety.Box(torch.hstack([env.safety.lower, -torch.ones(env.safety.lower.shape[0], args.red_dim)]), torch.hstack([env.safety.upper, torch.ones(env.safety.upper.shape[0], args.red_dim)]))
